...
public class FundingTaskScheduler {
    ...
    private final TaskScheduler fundingTaskScheduler;
    ...
    public void scheduleHoldToJudgment(Long fundingId, LocalDateTime holdTo) {
        ...
        try {
            fundingTaskScheduler.schedule(() -> fundingStatusUpdater.judgeFunding(fundingId), holdToInstant);
    ...
    public void scheduleActivation(Long fundingId, LocalDateTime startAt) {
        ...
        try {
            fundingTaskScheduler.schedule(() -> fundingStatusUpdater.activateFunding(fundingId), startInstant);
