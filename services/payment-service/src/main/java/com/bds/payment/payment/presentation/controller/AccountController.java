...
public class AccountController {
    ...
    public String accountRegister(@RequestHeader("X-Member-Id") Long memberId, @RequestBody @Valid AccountRegisterRequestDto dto) {
        return accountService.registerAccount(memberId, dto);
    }

    @PostMapping("/accounts/verify")
    public String accountVerify(@RequestHeader("X-Member-Id") Long memberId, @RequestBody @Valid AccountVerifyRequestDto dto) {
